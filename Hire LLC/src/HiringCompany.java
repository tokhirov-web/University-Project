public class HiringCompany
{
    ...
    public static void empEvaluation(int age, float gpa) {
        if (gpa >= 3f) {
            if (age >= 23) {
                System.out.println("The employee is eligible for consideration");
            } else {
                System.out.println("The employee is not eligible for consideration. Too young");
            }
        } else {
            System.out.println("The employee is not eligible for consideration. Low GPA");
        }
    }
    ...
    public static void addEmpToDB(String name, String[] arr, int freeSpace) {
        ...
        System.out.println("Current list of potential employees:");
        for(String n: arr) {
            if (n == null) {
                continue;
            }
    ...
    String[][] companyInfo = new String[20][2];
    companyInfo[0][0] = companyOneName;
    companyInfo[0][1] = industry1;

    companyInfo[1][0] = companyTwoName;
    companyInfo[1][1] = industry2;

    companyInfo[2][0] = companyThreeName;
    companyInfo[2][1] = industry3;

    companyInfo[3][0] = companyFourName;
    companyInfo[3][1] = industry4;
